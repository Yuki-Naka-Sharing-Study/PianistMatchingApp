...
class ProfileImageCell: UITableViewCell {
    ...
    func configure(profileImageString:String,
                   nameLabelString:String,
                   ageLabelString:String,
                   prefectureLabelString:String,
                   quickWordLabelString:String,
                   likeLabelString:String){
